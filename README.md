...
`dep-proj` is a Mill project with moderately complicated project depedencies (foreign modules and sub-projects etc) usefull for testing mill and it's integration with IDEs.
